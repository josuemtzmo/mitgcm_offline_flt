...
C     flt_outputDymVar :: output vorticity and kinetic energy 
C                         instead of temperature and salinity
      LOGICAL flt_outputDymVar
      COMMON / FLT_PARAM_L / flt_outputDymVar
